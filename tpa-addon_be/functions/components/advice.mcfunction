# PT 1 Advice
tellraw @a[tag=pt1,scores={time_counter=10}] {"rawtext":[{"text":"§f[§8Tpa System§f] : §rTempo de resposta expira em 45 segundos"}]}
...
# PT 2 Advice
tellraw @a[tag=pt2,scores={time_counter=10}] {"rawtext":[{"text":"§f[§8Tpa System§f] : §rTempo de resposta expira em 45 segundos"}]}
